 ...
 */
define("DB_USER", 'root');
define("DB_PASSWORD", 'ewere');
define("DB_NAME", 'pricepoint');
...
class Backup_Database {
     ...
     */
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8', $custname) {
        $this->host            = $host;
        ...
        echo $custname;
        $this->backupFile      = 'Sales-backup-'.$this->dbName.'-'.$custname.'.sql';
...
function backup($custname){
    
    $backupDatabase = new Backup_Database(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, CHARSET,$custname);
